...
export default class DateTimePickerPlus extends Vue {
  mounted() {
    console.log(this.$attrs, 'DateTimePickerPlus attrs')
    console.log(this.$listeners, 'DateTimePickerPlus listeners')
    console.log(this.$scopedSlots, 'DateTimePickerPlus scopedSlots')
  }
