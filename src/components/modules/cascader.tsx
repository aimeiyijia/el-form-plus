...
export default class CascaderPlus extends Vue {
  mounted() {
    console.log(this, 'CascaderPlus实例')
    console.log(this.$attrs, 'CascaderPlus attrs')
    console.log(this.$listeners, 'CascaderPlus listeners')
    console.log(this.$scopedSlots, 'CascaderPlus scopedSlots')
  }
